...
void main() {
  group('Hash Generation Integration Tests', () {
    testWithAuthMode('Test hash generation with HTTP polling',
    ...
    testWithAuthMode('Test hash generation without wait (manual polling)',
        (AuthTestContext context) async {
      final client = await createTestComputeClient(context);
